        ...
        <div className="flex flex-col items-start px-8 md:px-16 bg-gray-50 min-h-screen">
            ...
            <div className="flex flex-col lg:flex-row gap-12">
                ...
                <div className="flex-1">
                    ...
                    {/* <div className="italic text-gray-300 text-lg">Signature</div>*/}
                </div>
                ...
                <div className="flex-1 lg:ml-8">
                    ...
                    <div className="text-gray-600 space-y-2">
                        <p><span className="font-semibold">Name:</span> Damayanti Epili</p>
                        <p><span className="font-semibold">Age:</span> 19 Years</p>
                        <p><span className="font-semibold">Residence:</span> Navi Mumbai</p>
            ...
            {/* skills */}
            {/*<FaHtml5 /> <MdCss /><FaJava /> <FaGithub /> <BiLogoPostgresql /> <FaNode />*/}
            {/* Skills Section */}
